...
/**
 * Repositório SQL de relatórios compartilhado (Fase 3). Por enquanto contém o endpoint
 * EXTRAÍDO para a API dedicada: `resumosSimuladosRows` (a listagem de relatórios). Os demais
 * relatórios (estudante/gráficos/disciplina) seguem no app Next até serem migrados.
 */
...
// 1 query com agregação no banco (substitui os 4 fetchAllByIn do _resumos.ts).
// Participantes = alunos DISTINTOS entre sessões (reais) ∪ matrículas ∪ acessos.
const RESUMOS_SQL = `
WITH sims AS (
...
// ─────────────────────────────────────────────────────────────────────────────
// Relatório por ESTUDANTE (o mais pesado: aluno × turma).
// ─────────────────────────────────────────────────────────────────────────────
