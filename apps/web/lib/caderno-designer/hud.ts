...
export function hudCssVars(c: HudCores, dark = false): Record<string, string> {
  ...
  const acentos: Record<string, string> = {
    ...
    '--prova-inicio-btn': c.inicioBtn,
    '--prova-inicio-btn-fundo': c.inicioBtnFundo,
    // Estados ativo (hover) dos botões da prova encerrada.
    '--prova-caderno-btn-ativo': c.cadernoBtnAtivo,
    '--prova-caderno-btn-fundo-ativo': c.cadernoBtnFundoAtivo,
    '--prova-voltar-btn-ativo': c.voltarBtnAtivo,
    '--prova-voltar-btn-fundo-ativo': c.voltarBtnFundoAtivo,
    '--prova-inicio-btn-ativo': c.inicioBtnAtivo,
    '--prova-inicio-btn-fundo-ativo': c.inicioBtnFundoAtivo,
    '--prova-fita1': c.fita1,
    '--prova-fita2': c.fita2,
    '--prova-fita3': c.fita3,
    ...
    '--prova-bg-position': c.bgPosicao || 'center',
  }
