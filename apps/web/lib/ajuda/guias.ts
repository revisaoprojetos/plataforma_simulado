...
export const GUIAS: GuiaAjuda[] = [
  ...
  },
  {
    ...
    categoria: 'Simulados',
    rotas: ['/admin/simulados'],
    link: { label: 'Ir para Aplicação de Simulado', href: '/admin/simulados' },
    passos: [
      { titulo: 'Tudo é feito dentro do simulado', texto: 'As questões ficam cadastradas no sistema, mas você não precisa de uma área separada para montá-las numa prova: é tudo feito dentro do próprio simulado, na aba “Questões”.', rota: '/admin/simulados' },
      { titulo: 'Abra a prova na aba “Questões”', texto: 'Entre na prova (em “Aplicação de Simulado”) e clique na aba “Questões”. Depois use o botão “Adicionar questões”.', rota: '/admin/simulados', alvo: { txt: 'Novo simulado' } },
  ...
  {
    id: 'criar-banco',
    titulo: 'Organizar o conteúdo do simulado',
    resumo: 'Como montar questões, cadernos, HUD e grupos de um simulado, e vincular turmas para liberar acesso em massa — tudo nas abas da prova.',
    icone: BookOpen,
    categoria: 'Conteúdo',
    rotas: ['/admin/simulados'],
    link: { label: 'Ir para Aplicação de Simulado', href: '/admin/simulados' },
    passos: [
      { titulo: 'Abra a Aplicação de Simulado', texto: 'Clique em “Simulado” → “Aplicação de Simulado”. Todo o conteúdo (questões, personalização, cadernos, HUD, grupos e estudantes) é organizado nas abas do próprio simulado — não há mais uma área “Banco” separada.', rota: '/admin/simulados', alvo: { txt: 'Novo simulado' } },
      { titulo: 'Crie ou abra um simulado', texto: 'Crie um novo simulado ou abra um existente. Na aba “Personalizar” você define cor, ícone e capa do card para achar mais fácil depois.' },
      { titulo: 'Monte as questões', texto: 'Na aba “Questões”, adicione questões do sistema ou importe por planilha, reordene e ajuste — é a prova que o aluno vai fazer.' },
      { titulo: 'Vincule turmas', texto: 'Na aba “Estudantes” do simulado, vincule grupos/turmas — todos os membros passam a ter acesso a este simulado automaticamente.', dica: 'Também dá para adicionar alunos individualmente; a matrícula neste simulado é automática.' },
    ],
  },
  {
