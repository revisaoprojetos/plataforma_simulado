 ...
 *
 * O `resumosSimuladosRows` foi extraído para o pacote compartilhado `data` (Fase 3 — servido
 * também pela API dedicada); re-exportado aqui para manter os imports do app. Os demais
 * relatórios (estudante/gráficos/disciplina) seguem abaixo até serem migrados.
 */
export { resumosSimuladosRows, type ResumoRow } from 'data'
