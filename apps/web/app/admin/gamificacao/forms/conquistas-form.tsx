            ...
            return (
              <div key={c.id} className="group space-y-3 rounded-xl border bg-card p-3 shadow-sm">
                <div className="flex items-center gap-3">
                  <span className={`relative flex h-11 w-11 shrink-0 items-center justify-center rounded-full ${c.icone === 'rocket' ? 'overflow-hidden' : 'overflow-visible'}`} style={{ background: `color-mix(in oklab, ${cor} 18%, transparent)`, color: cor }}><ConquistaIconeFx icone={c.icone} /></span>
