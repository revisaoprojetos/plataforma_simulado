  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      <div className="grid gap-4 lg:grid-cols-2">
        <SectionCard titulo="XP por concluir simulado" className="space-y-4">
        ...
        <SectionCard titulo="XP por praticar (Banco de Questões)" className="space-y-4">
      ...
      <SectionCard titulo="Curva de níveis" descricao="Custo do nível n→n+1 = base + (n−1) × incremento. Cresce a cada nível.">
        ...
        <div className="mt-4 rounded-lg bg-muted/40 p-3 text-xs text-muted-foreground">
          <div className="mb-1 font-medium text-foreground">Prévia (XP acumulado para alcançar o nível):</div>
