...
export function SecaoLinks() {
  ...
  return (
    <Secao numero={5} titulo="Links de aula" descricao="(disciplina, aula) → tema + link por plataforma. Casa por texto exato com a aula da meta. A Montagem já traz os links do banco — aqui é para complementar. Opcional." colapsavel defaultAberto>
