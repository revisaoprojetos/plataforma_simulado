...
const MENSAGENS: Record<string, string> = {
  personalizar: 'Dê um nome ao cronograma (mín. 3 letras).',
  estrutura: 'Confira a estrutura: carga por dia, número de semanas e ao menos um dia de curso.',
}
...
export function CriarStepper() {
  ...
  function irPara(i: number) {
    ...
    router.push(`/admin/cronogramas/criar/${STEPS[i].slug}`)
  }
  ...
  async function criar() {
    ...
    setSalvando(true)
    try {
      // Import dinâmico: a ação pesada (cria cronograma + metas + links + acessos) só carrega ao clicar.
