...
export function SecaoAcessos() {
  ...
  return (
    <Secao numero={5} titulo="Acessos" descricao="Grupos de acesso que recebem o cronograma — é por eles que o aluno recebe. Opcional; dá para vincular depois." colapsavel defaultAberto>
      {carregando ? (
