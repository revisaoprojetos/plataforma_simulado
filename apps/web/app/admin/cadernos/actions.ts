...
// Import de Word migrado para a rota multipart POST /api/admin/caderno/importar-word
// (streaming + hospedagem de imagens no servidor). A antiga converterWordAction (base64
