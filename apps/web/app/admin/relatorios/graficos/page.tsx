...
import { RelatorioGraficoView, type DadosRelatorioGrafico } from './relatorio-grafico-view'
...
export default async function RelatorioGraficoPage() {
  ...
  // Simulados do tenant (base para filtrar sessões).
  ...
  const dados: DadosRelatorioGrafico = {
