...
export function ComentariosQuestao({ questaoId, embutido = false }: { questaoId: string; embutido?: boolean }) {
  ...
  // Modo embutido (dentro de uma aba): carrega os comentários direto, sem o botão de abrir.
  useEffect(() => { if (embutido && comentarios === null) carregar() }, [embutido, comentarios, carregar])
  ...
  // Embutido (dentro de uma aba): renderiza o conteúdo direto, sem o botão de abrir.
