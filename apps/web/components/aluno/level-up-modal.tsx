  ...
  return createPortal(
    <div className="fixed inset-0 z-[200] flex overflow-hidden" style={{ background: 'radial-gradient(circle at 50% 34%, #1a1730 0%, #0b0912 62%)', color: FG, animation: 'lu-in .3s ease both' }}>
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {/* logo do tenant GRANDE como fundo (marca-d'água) */}
        {logo && <img src={logo} alt="" className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 select-none" style={{ width: 'min(150vw, 1500px)', maxHeight: '150vh', objectFit: 'contain', opacity: 0.07, filter: 'grayscale(1) brightness(1.7)', animation: 'lu-halo 8s ease-in-out infinite' }} />}
